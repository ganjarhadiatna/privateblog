...
<script type="text/javascript">
	function getData() {
		...
		$.ajax({
			url: '{{ url("/setting/icon/save") }}',
			type: 'post',
			data: {'code': code, 'title': ttl, 'descr': descr},
		})
		.done(function(data) {
			if (data) {
	...
	<div class="header-mn">
		<div class="header-pl">
			<div class="hd-pl-left">
				<h1><a href="{{ url('/setting/info') }}">Form Ikon</a></h1>
			</div>
			...
			<div class="grid-1">
				<div class="form-field theme-1">
					<div class="block pad-bottom-15px">
						...
						<input type="text" name="code" class="txt txt-primary-color" placeholder="" id="code" value="" required="true">
					</div>
					<div class="block pad-bottom-15px">
					...
					<div class="block">
						...
						<textarea class="txt edit-text txt-full txt-primary-color" id="descr"></textarea>
					</div>
				</div>
				<div class="form-field theme-1">
